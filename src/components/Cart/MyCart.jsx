        ...
        <div className='flex flex-col gap-4'>
            ...
            <main className='flex flex-col'>
                ...
                <section className='w-full flex gap-4'>
                    ...
                    <div className='w-[75%] flex flex-col rounded-lg border border-gray-300 gap-4 p-4 justify-between'>
                                ...
                                <div className='flex flex-col font-light text-gray-400 gap-2 '>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex'>
                                            ...
                                            <p>Material: <span>Plastic</span></p>
                                        </div>
                    ...
                    <div className='w-[25%] flex flex-col gap-4'>
                        ...
                        <div className='flex flex-col border border-gray-300 rounded-lg p-4 gap-4'>
                            ...
                            <div className='w-full flex items-center'>
                                <input
                                    className='w-[80%] bg-gray-50 p-2 border border-gray-300 rounded-bl-sm rounded-tl-sm focus:outline-0'
                                    type="text"
                                    placeholder='Add Coupon' />
                                <button className='px-4 py-2 bg-blue-600 border border-blue-600 rounded-br-sm rounded-tr-sm font-light text-white hover:bg-blue-800 cursor-pointer active:scale-95 transition-all duration-200'>Apply</button>
                            </div>
                        </div>
