...
const ProfileDashboard = () => {
    return (
        <div className='w-[75%]'>
            <section className='bg-gray-50 border rounded-lg border-gray-300 py-3 px-6 '>
                <div className='text-2xl py-2'>
                    <h1>Edit Profile</h1>
                </div>

                <div className='flex py-4 px-8 gap-6'>
                    ...
                    <div className='w-[80%] grid grid-cols-2 gap-7 items-center'>
