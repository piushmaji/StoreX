...
const Dashboard = () => {
  ...
  const [photo, setPhoto] = useState(
    "https://i.pinimg.com/1200x/5d/41/bc/5d41bc0b19e55fc7aa8c659c9ec109d9.jpg",
  );
      ...
      <div className="bg-linear-to-br from-blue-700 via-blue-600 to-blue-500 rounded-3xl p-6 relative overflow-hidden">
        ...
        <div className="relative flex items-center gap-5">
            ...
            <div className="p-1 rounded-[20px] bg-white/30">
              <div className="w-18 h-18 rounded-2xl overflow-hidden">
                {photo ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-lg font-bold text-blue-700 bg-blue-100">
                    {initials}
                  </div>
                )}
              </div>
          ...
          <div className="flex flex-col">
            <p className="text-blue-200 text-[10px] font-semibold uppercase tracking-widest mb-1">
              Profile
            </p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {editingName ? (
              ...
              >
                <span
                  className={`text-sm font-medium ${name ? "text-gray-800" : "text-gray-300"}`}
                >
