...
const ProductCategory = ({ activeFilters, onOpenMobileFilters }) => {
  ...
  const onAddToCart = (e, product) => {
    ...
    handleAddToCart(user.id, product.id, variantId, 1);
  };
        ...
        <div className="flex items-center justify-between bg-white rounded-2xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-400 font-medium mt-1">
              Showing {totalItems} premium products
            </p>
          </div>
        </div>
        <FilterBar
        ...
        {loading
          ...
          : // Render Actual Products
            products.map((product) => {
              ...
              const image =
                product.image_urls?.[0] || "https://via.placeholder.com/300";
                  ...
                  <div className="flex-1 flex flex-col px-2">
                    ...
                    <div className="mt-auto pt-4 pb-1 flex items-end justify-between">
                      ...
                      <button 
                        ...
                        className="w-10 h-10 bg-slate-900 hover:bg-blue-600 text-white rounded-[14px] flex items-center justify-center transition-all duration-300 shadow-md hover:shadow-blue-500/30 hover:-translate-y-1 active:translate-y-0"
                      >
