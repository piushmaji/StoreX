...
const AboutSeller = ({ product }) => {
    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            {/* ── Seller Profile Card ── */}
            <div className="bg-linear-to-br from-blue-50 to-slate-50 rounded-2xl border border-blue-100 p-6">
            ...
            <div>
                ...
                <div className="flex gap-3 overflow-x-auto no-scrollbar pb-1">
                    {SELLER_PRODUCTS.map(({ id, title, price, img }) => (
                        <div key={id} className="shrink-0 w-36 bg-white rounded-2xl border border-blue-100 hover:border-blue-300 hover:shadow-md hover:shadow-blue-100 transition-all duration-200 overflow-hidden group cursor-pointer">
                            <div className="h-32 bg-linear-to-br from-blue-50 to-slate-50 flex items-center justify-center p-3">
            ...
            {/* ── Contact Seller ── */}
            <div className="bg-linear-to-br from-blue-50 to-slate-50 rounded-2xl border border-blue-100 p-5">
                <button
