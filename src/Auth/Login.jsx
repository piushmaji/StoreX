            ...
            <div className='max-w-md w-full space-y-8'>
                ...
                <div className='text-center'>
                    <div className='flex justify-center mb-4'>
                        <img
                            className='h-16 w-16 drop-shadow-lg bg-gray-50 border-2 border-blue-500 rounded-2xl p-2'
                            src={storex}
                            alt="StoreX Logo"
                        />
                    </div>
                    ...
                    <p className='mt-2 text-sm text-gray-600'>
                        ...
                        {activeTab === 'signup' && 'Join StoreX today'}
                ...
                <div className='bg-white rounded-2xl shadow-xl border border-gray-200 p-8'>
                    ...
                    {activeTab !== 'forgot' && (
                        <div className='flex gap-2 mb-6 bg-gray-100 p-1 rounded-lg'>
                            ...
                            <button
                                ...
                                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all ${activeTab === 'signup'
                                        ? 'bg-white text-blue-600 shadow-sm'
                                        : 'text-gray-600 hover:text-gray-900'
                                    }`}
                            >
                    ...
                    <form onSubmit={handleSubmit} className='space-y-4'>
                        ...
                        <button
                            type='submit'
                            className='w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200 active:scale-95'
                        >
                    ...
                    {activeTab !== 'forgot' && (
                        <button
                            ...
                            className='w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 active:scale-95'
                        >
