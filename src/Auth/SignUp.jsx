    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.code === 'auth/email-already-in-use') {
                ...
                setErrors({ firebase: "Something went wrong" })
            }
                ...
                <div className='max-w-md w-full'>
                    ...
                    <div className='bg-white rounded-2xl shadow-lg border border-gray-200 p-8'>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-5'>
                                ...
                                <div className='relative'>
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-10 pr-4 py-3 border ${errors.name ? 'border-red-500' : 'border-gray-300'
                                            } rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-gray-50`}
                            ...
                            {errors.firebase && (
                                <p className="text-red-500 text-sm text-center">{errors.firebase}</p>
                            )}
